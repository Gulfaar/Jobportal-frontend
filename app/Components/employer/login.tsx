          ...
          <div className="w-full max-w-sm">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <label className="inline-flex items-center text-sm md:text-base text-gray-600">
                  <input
                    type="checkbox"
                    className="form-checkbox h-4 w-4 text-[#2e6b66] rounded"
                    checked={rememberMe}
            ...
            <div className="flex justify-center space-x-6 mt-4">
              <button
                onClick={googleAuth}
                className="relative flex items-center justify-center px-6 py-2 border border-gray-300 rounded-md shadow-md bg-white hover:bg-gray-100 transition duration-200 cursor-pointer"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-4 text-sm md:text-base text-white/90">
              <li className="flex items-start gap-2">
                ...
                <span>Create a free account then upload or manually enter your CV.</span>
              </li>
              <li className="flex items-start gap-2">
                <Circle className="w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 mt-1 text-white" />
                <span>Let our AI-powered platform highlight your strengths and boost your visibility to employers.</span>
              </li>
              <li className="flex items-start gap-2">
                <Circle className="w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 mt-1 text-white" />
                <span>Add your skills, experience, and preferred job sectors to get matched faster.</span>
              </li>
              <li className="flex items-start gap-2">
                <Circle className="w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 mt-1 text-white" />
                <span>Our AI finds the best job opportunities based on your profile, no endless searching.</span>
              </li>
              <li className="flex items-start gap-2">
                <Circle className="w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 mt-1 text-white" />
                <span>Apply for verified positions across 22+ countries with trusted employers.</span>
              </li>
              <li className="flex items-start gap-2">
                <Circle className="w-3 md:w-4 lg:w-5 h-3 md:h-4 lg:h-5 mt-1 text-white" />
                <span>Get certified, interview-ready, and deployed with end-to-end career assistance from Gulfaar.</span>
              </li>
            </ul>
          </div>
