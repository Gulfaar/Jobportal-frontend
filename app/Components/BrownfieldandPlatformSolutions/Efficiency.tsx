...
const Efficiency = () => {
  const efficiencyPoints = [
    {
      title: "Aligned with Vision ",
      description: "Our Brownfield and Platform services support Saudi Arabia’s strategic energy goals, contributing to sustainability and modernization in line with Vision 2030.",
      icon: "/efficiencyicon1.svg"
    },
    {
      title: "Enhancing Operational Efficiency",
      description: "We optimize existing offshore infrastructure through safe, precise upgrades and modifications, reducing downtime and boosting performance.",
      icon: "/efficiencyicon2.svg"
    },
    {
      title: "Supporting Energy Leadership",
      description: "By extending asset life and ensuring compliance, we help maintain the Kingdom’s position as a global leader in energy production.",
