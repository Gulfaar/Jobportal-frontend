    ...
    return (
      <div className="relative w-full h-[400px] flex justify-center items-center text-center px-4 sm:px-8 md:px-16 lg:px-32">
        ...
        <div
          ...
          style={{
            backgroundColor: "#FFF200", // Solid yellow background as in the image
          }}
        >
          <div className="absolute inset-0 bg-[#FFF200] opacity-70"></div> {/* Adjusted opacity */}
        </div>
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="mt-6 flex justify-center items-center space-x-18  ">
