        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div>
              ...
              We are deeply integrated with offshore & onshore oil operations
              </p>
            </div>
            ...
            {isOpen && (
              ...
              >
                <div className="space-y-4 bg-white text-[#2A6360] p-6 rounded-b-lg shadow-lg">
                  <ServiceItem text="Subsea inspection, ROV & diving support" />
                  <ServiceItem text="Oil tank cleaning, degassing & sludge disposal" />
                  <ServiceItem text="Brownfield modifications & platform extension" />
                  <ServiceItem text="NDT inspection, QA/QC, cathodic protection" />
                  <ServiceItem text="SBM, SPM maintenance & high-risk access" />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
