        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div>
              ...
              Our technical team includes certified inspectors delivering
              </p>
            </div>
            ...
            {isOpen && (
              ...
              >
                <div className="space-y-4 bg-white text-[#2A6360] p-6 rounded-b-lg shadow-lg">
                  <ServiceItem text="HVAC balancing & air quality assessments" />
                  <ServiceItem text="Third-party QA/QC and ISO audits" />
                  <ServiceItem text="NDT, LPT, RT, UT, MPI & vacuum box testing" />
                  <ServiceItem text="Civil and structural inspection" />
                  <ServiceItem text="Visual, leak, pressure, thickness & torque testing" />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
