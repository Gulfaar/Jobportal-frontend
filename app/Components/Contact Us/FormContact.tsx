const FormContact = () => {
    return (
        <section className="flex flex-col md:flex-row items-stretch justify-center p-10 bg-white gap-8 ">
          ...
          <div className="w-full md:w-1/3 bg-[#2E5F5C] bg-opacity-80 text-white p-8 rounded-lg shadow-lg flex flex-col justify-between">
            <div>
          ...
          {/* Contact Form */}
          <div className="w-full md:w-2/3 bg-gray-100 p-8 rounded-lg shadow-lg">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <input type="email" placeholder="E-mail" className="border p-3 rounded-lg w-full" />
              ...
              <textarea placeholder="Write a message" className="border p-3 rounded-lg w-full h-32"></textarea>
    
              <button className="bg-[#2E5F5C] text-white px-6 py-3 rounded-lg hover:bg-opacity-80 transition">Send Message</button>
            </form>
          </div>
        </section>
    );
