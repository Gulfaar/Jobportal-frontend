...
// Main component that assembles all sections
const CountryPresence: React.FC = () => {
  return (
...
// Section about Gulfaar's presence with text and world map
const PresenceSection: React.FC = () => {
  return (
    <section className="px-10 py-12 bg-[linear-gradient(180deg,#DEF9FF_0%,rgba(224,218,117,0.00)_100%)] max-md:px-5 max-sm:px-4">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="flex justify-between items-center gap-9 max-lg:flex-col">
  <p className="text-2xl tracking-tight leading-9 max-w-[743px] text-neutral-900 max-md:text-xl max-md:leading-8">
    ...
    <em>
      ...
      <strong>
        recruitment, outsourcing, skill development, and contract-based hiring
      </strong>
    </em>{" "}
    across multiple industries. With a{" "}
    <em>strong local team and AI-powered hiring technology</em>, we ensure that
    businesses find the right talent and job seekers access the best career
    opportunities.
  </p>
  <img
    src="https://cdn.builder.io/api/v1/image/assets/TEMP/42454fd2ac0df575330fe1d9beb3f9a1ff9da8ef"
    alt="World Map"
    className="w-[469px] h-[336px] object-contain max-lg:w-[50%] max-md:w-full"
  />
</div>
...
// Section showing branch locations with an image and details
...
const TeamMember: React.FC<TeamMemberProps> = ({ imagePath, name, role }) => {
  return (
    <article className="p-5 text-center rounded-xl bg-[#2E5F5C] bg-opacity-50 w-[281px]">
      <img
        src={imagePath}
        alt={name}
...
// Section showcasing team members
...
// Section showing industries served
