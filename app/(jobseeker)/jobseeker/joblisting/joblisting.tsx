    ...
    return (
      ...
      {filteredJobs.length > 0 ? (
        filteredJobs.map((job) => {
          ...
          return (
            <div key={job.id} className="bg-white rounded-lg shadow-md p-8 border relative md:w-full">
                ...
                <button
                  ...
                  className={`flex-1 ${
                    isApplied
                      ...
                      : "bg-[#2E5F5C] text-white hover:bg-[#2b2d2d]"
                  } px-3 py-1.5 rounded text-sm border border-[#2E5F5C]`}
                >
